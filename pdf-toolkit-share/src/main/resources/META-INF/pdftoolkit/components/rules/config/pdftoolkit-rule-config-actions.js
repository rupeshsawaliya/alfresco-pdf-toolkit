			...
			"pdftoolkit:select-file-dialog-button":
			{
				...
				edit: function (containerEl, configDef, paramDef, ruleConfig, value)
				{
					...
					if(!this.widgets.selectedFileDialog)
					{
						...
						var getDocLibNodeRefUrl;
                        						//when we enter edit mode, set up the document picker
                        if(this.options.siteId){
                            getDocLibNodeRefUrl = Alfresco.constants.PROXY_URI + "slingshot/doclib/container/" + this.options.siteId + "/documentlibrary";
                            ...
                            getDocLibNodeRefUrl = Alfresco.constants.PROXY_URI + "api/forms/picker/node/alfresco/company/home/children";
                                    Alfresco.util.Ajax.jsonGet(
                            						{
                            							url: getDocLibNodeRefUrl,
                            							successCallback:
